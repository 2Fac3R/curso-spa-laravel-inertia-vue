                    ...
                    <div class="mt-5 md:col-span-2 md:mt-0">
                        <div class="p-4 bg-white shadow md:rounded-md">
                            <div class="flex justify-between">
                                <input type="text" class="rounded-md shadow-sm form-input" placeholder="Buscar..." v-model="q">

                                <inertia-link :href="route('notes.create')" class="px-4 py-2 font-bold text-white bg-blue-500 rounded-md">
                                    Crear
                                </inertia-link>
                            </div>
                            <hr class="my-6">
